...
var APP_ID = "amzn1.ask.skill.8f5d5ea3-3e62-470c-978d-65729f69f0d1";

var URL = "https://api.dineoncampus.com/v1/events/public_list?site_id=5751fd3790975b60e04893f2";
// Skills name 
var skillName = "UT Dallas Dining Events:";
...
var descriptionMessage = "Here's some additional information ";

//Used when there is no description to an event
var noDescriptionMessage = "There is no additional information for this event ";
...
var cardTitle = "UTD Dining Events";
            ...
            request.get({
                ...
                if (err) {
                    ...
                    for(var k in data.events) {
                            ...
                            var eventData = {
                                summary: removeTags(item.title),
                                description: removeTags(item.description),
                                start: Date.parse(item.start.substring(0, item.start.lastIndexOf('-')))
                            };
...
var descriptionHandlers = Alexa.CreateStateHandler(states.DESCRIPTION, {
    'eventIntent': function () {
        ...
        if (relevantEvents[index]) {
            if (typeof relevantEvents[index].description !== 'undefined' && relevantEvents[index].description) {
                output = descriptionMessage + removeTags(relevantEvents[index].description);
            } else {
                output = noDescriptionMessage;
            }
